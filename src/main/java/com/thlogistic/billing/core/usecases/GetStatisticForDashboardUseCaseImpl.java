...
public class GetStatisticForDashboardUseCaseImpl implements GetStatisticForDashboardUseCase {

    private final BillingRepository repository;

    @Override
    public GetBillingStatisticResponse execute() {
        ...
        List<BillingEntity> entityList = repository.findAll();
